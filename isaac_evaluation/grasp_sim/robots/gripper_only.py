...
class GripperOnly():
    def __init__(self, gym, sim, env, isaac_base, env_number, pose, collision_group=0, segmentationId=0):
        ...
        # self.gym.set_actor_scale(self.env, self.handle, 1.5)
        # self.gym.set_actor_scale(self.env, self.handle, 5 * self.gym.get_actor_scale(self.env, self.handle))
        # self.gym.set_actor_scale(self.env, self.hand_handle, 1.0)
        # self.gym.set_actor_scale(self.env, self.hand_handle, 5 * self.gym.get_actor_scale(self.env, self.hand_handle))
    ...
    def set_assets(self):
        ...
        # asset_options.thickness = 0.0  # TODO: change this along w obj
